...
export default function Detail(){
  ...
  const message = `Olá ${incident.name}, estou entrando em contato, pois, gostaria de ajudar no caso "${incident.titulo}" com valor de ${Intl.NumberFormat('pt-BR', { style: 'currency', currency:'BRL' }).format(incident.value)}`;
